                ...
                <div class="col-lg-12 text-center">
					...
					<form method="post" action="../controller/pageConfirmationModificationCompetition.controller.php">
						<p>
							...
							<input type="text" name="image" id="image" value="<?php echo $competition[0]['image_competition'];?>"/>

							<br />
							<input type='hidden' name='id' value="<?php echo $competition[0]['id_competition'];?>"/>
							<br />
