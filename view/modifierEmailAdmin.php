		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12 text-center">
					<h2>Formulaire modification Email</h2>
					<hr class="star-primary">
					<!-- Création du formulaire de modification de l'email admin -->
					<form method="post" action="/controller/pageConfirmationModificationEmailAdmin.controller.php">
						<p>
