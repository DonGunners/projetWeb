				...
				<div class="col-lg-12 text-center">
					...
					<div class="table-responsive">
						<table class="table table-bordered">
							...
							<tbody>
							<!-- on affiche pour chaque pronostic possible les informations de la rencontre -->
							<?php
								while($donnees=$listePronos->fetch()){
									...
									//Ajout d'une liste déroulante avec les trois choix de pronostic possible, et un script js pour modifier le lien de confirmation -->
